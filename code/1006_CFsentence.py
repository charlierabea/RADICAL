...
xls = pd.ExcelFile('/raid/jupyter-alz.ee09/Excel/finaleval_ALL_caption.xlsx')
sheet_names = xls.sheet_names  # Get all sheet names

with pd.ExcelWriter('/raid/jupyter-alz.ee09/Excel/finaleval_ALL_CFcaption3.xlsx') as writer:
