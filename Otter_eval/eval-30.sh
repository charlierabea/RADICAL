...
CUDA_VISIBLE_DEVICES=0,1 accelerate launch --config_file=./pipeline/accelerate_configs/accelerate_config_fsdp.yaml \
pipeline/train/0830_eval-30_examples.py \
--pretrained_model_name_or_path="/raid/jupyter-alz.ee09/Otter_checkpoints/OTTER-LLaMA7B-MED_CLIP_hf/" \
--mimicit_path="/raid/jupyter-alz.ee09/data/eval_instruction.json" \
